package com.kellen.umcfixer.mixinplugin;
...
public enum TargetedMod {
    ...
    IMMERSIVERAILROADING("ImmersiveRailroading", "ImmersiveRailroading", true),
    UNIVERSALMODCORE("UniversalModCore", "UniversalModCore", true);
